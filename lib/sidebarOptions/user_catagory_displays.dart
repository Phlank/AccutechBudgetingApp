...
class _HousingView extends State<HousingView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('housing');
}

class _UtilitiesView extends State<UtilitiesView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('utilities');
}
...
class _GroceriesView extends State<GroceriesView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('groceries');
}

class _SavingsView extends State<SavingsView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('savings');
}

class _HealthView extends State<HealthView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('health');
}

class _TransportationView extends State<TransportationView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('transportation');
}

class _EducationView extends State<EducationView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('education');
}

class _EntertainmentView extends State<EntertainmentView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('entertainment');
}

class _KidsView extends State<KidsView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('kids');
}

class _PetsView extends State<PetsView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('pets');
}

class _MiscView extends State<MiscView> {
  @override
  Widget build(BuildContext context) =>
      new GeneralCategory().generalDisplay('miscellaneous');
}
...
class GeneralCategory {
  ...
  List getSpecificTransactions(BudgetCategory category) {
    List retList = [];
    for(Transaction tran in userBudget.transactions){
