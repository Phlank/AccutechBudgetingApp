...
class InputValidator {
  ...
  static const String requiredMessage = 'Required field';

  static bool pin(String input) {
    return new RegExp(_regexMap['pin']).hasMatch(input);
  }

  static const String pinMessage = 'Must be four digits';
  ...
  static const String dollarMessage = 'Must be a valid dollar amount';
